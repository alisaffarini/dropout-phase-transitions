...
\begin{table}[t]
    ...
    \end{tabular}
    \vspace{0.3em}
    \small{Note: MLP on CIFAR-100 is omitted due to computational constraints (the combination did not converge within the allocated budget). VGG-11 on CIFAR-100 failed to train above chance (0.5\%), so phase transition metrics are undefined.}
\end{table}
